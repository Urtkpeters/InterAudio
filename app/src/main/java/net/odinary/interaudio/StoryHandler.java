...
class StoryHandler
{
    ...
    StoryHandler(MainActivity activity)
    {
    ...
    public void startPlay()
    {
        ...
        try
        {
            ...
            MediaPlayer mediaPlayer = MediaPlayer.create(mainActivity.getApplicationContext(), Uri.parse(mainActivity.getPackageHandler().getPackageDir() + currentPath.get("filename") + "." + storyJson.get("audioFileExt")));
    ...
    {
        File storyFile = new File(mainActivity.getPackageHandler().getPackageDir() + storyFileName);
