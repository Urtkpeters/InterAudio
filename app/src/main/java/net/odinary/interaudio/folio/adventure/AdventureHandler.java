package net.odinary.interaudio.folio.adventure;
...
import net.odinary.interaudio.folio.adventure.repository.PlayerRepository;
import net.odinary.interaudio.folio.adventure.repository.WorldRepository;
...
public class AdventureHandler
{
    ...
    public void startPlay()
    {
        try
        {
            ...
            else currentAdventure = new Adventure(mainActivity.getFolioHandler().getPackageDir() + jsonFilename, conditionHandler, triggerHandler);
    ...
    {
        return MediaPlayer.create(mainActivity.getApplicationContext(), Uri.parse(mainActivity.getFolioHandler().getPackageDir() + clipList.get(0) + "." + currentAdventure.getAudioFileExt()));
    }
