package net.odinary.interaudio.folio.adventure.odi.trigger;

import net.odinary.interaudio.folio.adventure.AdventureHandler;
import net.odinary.interaudio.folio.adventure.Event;
import net.odinary.interaudio.folio.adventure.component.Component;
...
import net.odinary.interaudio.folio.adventure.odi.AbstractOdiHandler;
import net.odinary.interaudio.folio.adventure.odi.OdiSegment;
import net.odinary.interaudio.folio.adventure.repository.EntityRepository;
